...
There, we will make you visit the city in a playful way, by participating to a **giant treasure hunt**, where you will have to solve some problems and riddles to find your way to the ultimate goal.

![Treasure hunt](/images/events/luxembourg/treasure-map-153425_640.png)

And then we will gather in a **special location for dinner & drink**, probably more games and maybe some dancing, for the more adventurous.

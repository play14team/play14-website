...
You should specify the URL of the Eventbrite sub site that was automatically generated.
You will also need to provide the URL of the _tickets_ widget that you have generated in Eventbrite.
The URL for the _countdown_ widget is optional. 

```yaml
registration: 
  #type of registration should be eventbrite
  type: eventbrite
  # url pointing to the event on Eventbrite website
  site: https://play14-luxembourg2017.eventbrite.com 
  # url of the tickets widget generated by Eventbrite
  tickets-widget: https://www.eventbrite.com/tickets-external?eid=28083088273&ref=etckt 
  # url of the countdown widget generated by Eventbrite
